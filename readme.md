...
*   **Custom Centered Glowing Popups**: Replaced all native browser alert/confirm dialogues with a custom, glowing, mobile-responsive glassmorphism popup component (`CustomPopup`) that automatically focuses on primary CTAs to enable keyboard-only navigation.
