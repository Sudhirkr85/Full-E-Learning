  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex md:hidden">
      ...
      <a
        ...
        className="flex flex-1 items-center justify-center gap-2 bg-blue-600 py-4 text-white font-semibold text-sm active:bg-blue-700"
      ...
      <a
        ...
        className="flex flex-1 items-center justify-center gap-2 bg-green-600 py-4 text-white font-semibold text-sm active:bg-green-700"
